...
//    [SKRoutingService sharedInstance].visualAdviceConfigurations = array;
    [[SKRoutingService sharedInstance] startNavigationWithSettings:_navigationSettings];
    NSArray *routeAdviceList = [[SKRoutingService sharedInstance] routeAdviceListWithDistanceFormat:SKDistanceFormatMetric];
...
#pragma mark - SKTNavigationDelegate methods
